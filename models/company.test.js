...
describe("findAll", function () {
  ...
  test("works: with nameLike, minEmployees, and maxEmployees filters", async function () {
    let companies = await Company.findAll({
      nameLike: "c",
      minEmployees: 2,
      maxEmployees: 3,
  ...
  test("works: with invalid minEmployees and maxEmployees filters", async function () {
    let companies = await Company.findAll({
      minEmployees: 4,
      maxEmployees: 2,
    });
